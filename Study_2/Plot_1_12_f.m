...
hold on
bar_width   =   0.25;
b           =   bar([1,2,3] + 0.3,[mean_sham([1,12])',mean_follow_sham], bar_width);
b.FaceColor =   'flat';
b.CData     =   Sham_color;

b           =   bar([1,2,3] - 0.3,[mean_tDCS([1,12])',mean_follow_tDCS], bar_width);
b.FaceColor =   'flat';
...
set(gcf, 'Position',  [396        1134         159         129])
box off
